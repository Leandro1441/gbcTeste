...
export class Migration1612447442980 implements MigrationInterface {
    name = 'Migration1612447442980'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `medicos_especialidades` (`medicoEspecildadeId` varchar(36) NOT NULL, `created` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `version` int NOT NULL DEFAULT '0', `CRM` varchar(9) NOT NULL, `especialidadeId` varchar(36) NOT NULL, PRIMARY KEY (`medicoEspecildadeId`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `medicos_especialidades` ADD CONSTRAINT `FK_c0eba57bb58c6b9578c4e7b9f53` FOREIGN KEY (`especialidadeId`) REFERENCES `especialidades`(`especialidadeId`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `medicos_especialidades` DROP FOREIGN KEY `FK_c0eba57bb58c6b9578c4e7b9f53`");
